...
(function(){
  ...
  s.textContent=".sh3-fe-tree.svelte-gk9ydj,.sh3-fe-tree.svelte-gk9ydj ul:where(.svelte-gk9ydj){list-style:none;padding:0;margin:0}.sh3-fe-node.svelte-gk9ydj{background:none;border:0;color:inherit;cursor:pointer;padding:2px 4px;text-align:left;width:100%;font:inherit}.sh3-fe-node.svelte-gk9ydj:hover{background:var(--sh3-hover, #1e1e1e)}.sh3-fe-node.selected.svelte-gk9ydj{background:var(--sh3-selection, #2d4a7a)}.sh3-fe-empty.svelte-gk9ydj{color:var(--sh3-muted, #888);padding:8px}.sh3-fe-panel__empty.svelte-1vm0wsq{color:var(--sh3-muted, #888)}.sh3-fe-panel__header.svelte-1vm0wsq{border-bottom:1px solid var(--sh3-border, #2a2a2a);padding-bottom:6px;margin-bottom:8px}.sh3-fe-panel__path.svelte-1vm0wsq{font-weight:600}.sh3-fe-panel__shard.svelte-1vm0wsq{font-size:.85em;color:var(--sh3-muted, #888)}.sh3-fe-panel__actions.svelte-1vm0wsq{display:flex;flex-wrap:wrap;gap:6px;margin-top:8px}.sh3-fe-panel__action.svelte-1vm0wsq{background:var(--sh3-surface, #1a1a1a);color:var(--sh3-fg, #eee);border:1px solid var(--sh3-border, #2a2a2a);padding:4px 10px;font:inherit;cursor:pointer;border-radius:3px}.sh3-fe-panel__action.svelte-1vm0wsq:hover{background:var(--sh3-surface-hover, #222)}.sh3-fe-panel__action.primary.svelte-1vm0wsq{border-color:var(--sh3-accent, #4a9eff)}.sh3-fe-panel__action[disabled].svelte-1vm0wsq{opacity:.5;cursor:progress}.sh3-fe-browser.svelte-sykudp{display:grid;grid-template-columns:minmax(240px,1fr) minmax(260px,1fr);height:100%;gap:1px;background:var(--sh3-border, #2a2a2a)}.sh3-fe-browser__tree.svelte-sykudp,.sh3-fe-browser__panel.svelte-sykudp{background:var(--sh3-bg, #111);overflow:auto;padding:8px}";
